...
class Generator(t.nn.Module):
    def __init__(self):
        ...
        self.deconv1 = t.nn.Sequential(
            t.nn.ConvTranspose2d(in_channels=CONFIG["NOISE_DIM"], out_channels=64 * 4, kernel_size=4, stride=1, padding=0, bias=False),
...
class Discriminator(t.nn.Module):
    def __init__(self):
        ...
        self.conv1 = t.nn.Sequential(
            t.nn.Conv2d(in_channels=CONFIG["IMAGE_CHANNEL"], out_channels=64, kernel_size=4, stride=2, padding=1, bias=False),
        ...
        self.conv4 = t.nn.Sequential(
            t.nn.Conv2d(in_channels=64*4, out_channels=1, kernel_size=4, stride=2, padding=0, bias=False)
        )
...
dataset = j_data.Cifar10DataSetForPytorch(root=CONFIG["DATA_PATH"], train=True, transform=tv.transforms.Compose([
