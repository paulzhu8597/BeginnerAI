...
class Generator(t.nn.Module):
    def __init__(self):
        ...
        self.fc1 = t.nn.Sequential(
            t.nn.Linear(CONFIG["NOISE_DIM"], 512 * 4 * 4),
            t.nn.BatchNorm1d(512 * 4 * 4),
            t.nn.ReLU()
        )

        self.deconv1 = t.nn.Sequential(
            t.nn.ConvTranspose2d(512, 256, 4, 2, 1),
            t.nn.BatchNorm2d(256),
            t.nn.ReLU()
        )

        self.deconv2 = t.nn.Sequential(
            t.nn.ConvTranspose2d(256, 128, 4, 2, 1),
...
class Discriminator(t.nn.Module):
    def __init__(self):
        ...
        self.conv1 = t.nn.Sequential(
            t.nn.Conv2d(CONFIG["IMAGE_CHANNEL"], 32, 4, 2, 1),
            t.nn.LeakyReLU(0.2)
        )

        self.conv2 = t.nn.Sequential(
            t.nn.Conv2d(32, 64, 4, 2, 1),
            t.nn.BatchNorm2d(64),
            t.nn.LeakyReLU(0.2)
        )
