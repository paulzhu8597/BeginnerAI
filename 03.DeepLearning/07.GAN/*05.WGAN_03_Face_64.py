...
class Generator(t.nn.Module):
    def __init__(self):
        ...
        self.deconv5 = t.nn.Sequential(
            t.nn.ConvTranspose2d(in_channels=64, out_channels=CONFIG["IMAGE_CHANNEL"], kernel_size=4, stride=2, padding=1, bias=False),
            t.nn.Tanh()
        )
...
for epoch in range(1, CONFIG["EPOCH"] + 1):
    ...
    tv.utils.save_image(fake_u.data,'outputs/Faces_%03d.png' % epoch,nrow=10, normalize=True,range=(-1,1), padding=0)